    ...
    <div class="input-group">
        ...
        <span class="input-group-append">
            <button type="submit" class="btn-sm searchform__submit" title="Buscar">
                ...
                <g>
                <path class="st0" d="M21.8,19.3l-4.6-4.6c1.1-1.6,1.7-3.4,1.7-5.3c0-1.3-0.2-2.5-0.7-3.7c-0.5-1.2-1.2-2.2-2-3
                ...
                c1.6,0,3.1,0.6,4.2,1.8c1.2,1.2,1.8,2.6,1.8,4.2C15.4,11.1,14.8,12.5,13.6,13.6z"/>
                </g>
                </svg>
            </button>
        </span>
