...
<div class="wp-block-group ajuda">
  ...
  <div class="wp-block-buttons">
    ...
    <div class="wp-block-button"><a class="wp-block-button__link has-text-align-center wp-element-button">Perguntas Frequentes</a></div>
    <!-- /wp:button -->

    <!-- wp:button {"textAlign":"center"} -->
    <div class="wp-block-button"><a class="wp-block-button__link has-text-align-center wp-element-button">Tutoriais</a></div>
    <!-- /wp:button -->
  </div>
  <!-- /wp:buttons -->
</div>
