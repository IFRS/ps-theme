...
<form class="form-inline cursos__filters" method="POST" action="<?php echo get_post_type_archive_link( 'curso' ); ?>" role="form">
    ...
    <select name="modalidade[]" id="<?php echo $field_id; ?>" class="form-control form-control-sm my-1 mr-2 w-25">
    ...
    <select name="turno[]" id="<?php echo $field_id; ?>" class="form-control form-control-sm my-1 mr-2 w-25">
    ...
    <button type="submit" class="btn btn-sm" title="Buscar">
