        ...
        <div class="row">
            <div class="col-xs-12">
                <p>
                    ...
                    &mdash;
                    <!-- Código-fonte GPL -->
                    <a href="https://bitbucket.org/ricardomoro/ps-2017-1/" target="blank">C&oacute;digo-fonte deste tema sob a licen&ccedil;a GPLv3<span class="sr-only"> (abre uma nova p&aacute;gina)</span></a> <span class="glyphicon glyphicon-new-window"></span>
                    &mdash;
                    <!-- Creative Commons -->
