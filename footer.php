    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <p>
                    <!-- Wordpress -->
                    <a href="http://br.wordpress.org/" target="_blank" rel="noopener">Desenvolvido com Wordpress<span class="sr-only"> (abre uma nova p&aacute;gina)</span></a> <span class="glyphicon glyphicon-new-window"></span>
                    &mdash;
                    <!-- Código-fonte GPL -->
                    <a href="https://github.com/IFRS/ps-theme/" target="_blank" rel="noopener">C&oacute;digo-fonte deste tema sob a licen&ccedil;a GPLv3<span class="sr-only"> (abre uma nova p&aacute;gina)</span></a> <span class="glyphicon glyphicon-new-window"></span>
                    &mdash;
                    <!-- Creative Commons -->
