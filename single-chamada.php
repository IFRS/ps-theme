                ...
                <div class="row mb-5">
                    ...
                    <?php if (!empty($bancas)) : ?>
                        <div class="col col-md-6">
                            <div class="card bg-light">
                                <div class="card-header">
                                    <strong><?php _e('Bancas de Heteroidentificação e Análise de Renda', 'ifrs-ps-theme'); ?></strong>
                                </div>
                                <div class="list-group list-group-flush">
                                    ...
                                    <?php if ($documentos->have_posts()) : ?>
                                        <?php while ($documentos->have_posts()) : $documentos->the_post(); ?>
                                            ...
                                            <?php if (!empty($arquivos)) : ?>
                                                <a href="#collapse-arquivos-<?php echo get_the_ID(); ?>" class="list-group-item list-group-item-action list-group-item-secondary collapsed chamada-single__documento-link" role="button" data-toggle="collapse" aria-expanded="false" aria-controls="collapse-arquivos-<?php echo get_the_ID(); ?>"><?php the_title(); ?></a>
